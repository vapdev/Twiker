<template>
    <div class="sticky max-[600px]:fixed max-[600px]:bottom-0 min-[600px]:top-0 min-[600px]:left-0 max-[600px]:right-0 h-screen max-[600px]:h-12 max-[600px]:w-screen bg-white dark:bg-slate-900 max-[600px]:overflow-y-hidden overflow-auto">
