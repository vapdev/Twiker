<template>
    <div class="flex h-screen w-screen bg-white dark:bg-dark">
    ...
    <div class="w-2/4 dark w-50 flex items-center justify-center border-l-2 border-gray-500 text-black dark:text-gray-400">
