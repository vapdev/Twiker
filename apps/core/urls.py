...
from apps.core.views import ImageViewSet, VerifyTokenView, logout_view, UsersList, FollowersList, FollowingList

urlpatterns = [
    path('api/v1/auth/logout/', logout_view, name='logout'),
    path('api/v1/token/verify/', VerifyTokenView.as_view(), name='verify_token'),
